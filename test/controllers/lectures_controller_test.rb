...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference("Lecture.count") do
      post lectures_url, params: { lecture: { desc: @lecture.desc, hours: @lecture.hours, name: @lecture.name } }, as: :json
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { desc: @lecture.desc, hours: @lecture.hours, name: @lecture.name } }, as: :json
    assert_response :success
  end
